    ...
    <div className="font-sans text-gray-800 bg-white min-h-screen">
      ...
      <header className="bg-teal-500 text-white py-6 px-8 flex justify-between items-center shadow-md sticky top-0 z-50">
        ...
        <nav className="space-x-8 text-lg font-semibold">
          ...
          <Link to="/login" className="hover:text-yellow-200 transition-colors duration-300">Login</Link>
          <Link to="/signup" className="hover:text-yellow-200 transition-colors duration-300">Sign Up</Link>
        </nav>
      </header>
